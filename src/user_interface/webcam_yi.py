...
class DryHand(QWidget):
    ...
    def start(self):
        ...
        # # self.timer.timeout.connect(self.tes)
        # self.timer.start(1000 / self.fps)
        self.predict()
    ...
    def predict(self):
        ...
        # self.landmark_list, bbox = self.detector.findPosition(self.img, draw=False)
        # # if self.landmark_list:
        # #     fingers = self.detector.fingersUp()
        # # else:
        # #     continue
        # de = Demo01.demo()
        # de.startVideo(self.img, self.landmark_list)
    # 모델 추론 및 UI에 영상 출력
        # success, img = self.cpt.read()
